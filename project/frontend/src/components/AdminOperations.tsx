...
export function SameDayDeliveryAdmin() {
  ...
  if (loading || !settings) {
    return <Loader2 className="mx-auto my-16 h-6 w-6 animate-spin text-wine-600" />;
  }
...
export function AdminReturnsManager() {
  ...
  return (
    <section className="font-sans">
      ...
      {loading ? (
        <div className="py-12 text-center text-sm text-ink-700/60">Loading return requests…</div>
      ) : filtered.length === 0 ? (
