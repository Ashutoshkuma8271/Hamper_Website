  ...
  return (
    <section id="top" className="relative pt-28 sm:pt-36 pb-16 sm:pb-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        <div>
          <span className="inline-flex items-center gap-2 rounded-full border border-gold-400/40 bg-cream-100 dark:bg-gray-800 dark:text-gold-300 dark:border-gold-500/40 px-4 py-1.5 text-xs font-medium tracking-wide text-wine-600 uppercase">
            <span className="h-1.5 w-1.5 rounded-full bg-gold-500" />
            Personalised gifting, since 2016
          </span>

          <h1 className="mt-6 font-display font-semibold text-wine-800 dark:text-white text-balance text-4xl sm:text-5xl lg:text-6xl leading-[1.05] tracking-tight">
            Hampers that feel{' '}
            <span className="relative inline-block">
              <span className="italic text-gold-600 dark:text-gold-400">hand-written</span>
              <svg
          ...
          <p className="mt-6 text-lg text-ink-700/80 dark:text-gray-200 max-w-xl leading-relaxed">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-wine-600/40 dark:border-cream-200/40 px-7 py-3.5 text-sm font-medium text-wine-700 dark:text-white dark:bg-gray-800/90 dark:hover:bg-gray-700 transition-colors cursor-pointer shadow-sm"
            >
              How it works
            </a>
          </div>
          ...
          <div className="mt-10 flex items-center gap-6">
            ...
            <p className="text-sm text-ink-700/70 dark:text-gray-300">
              <span className="font-semibold text-ink-800 dark:text-white">12,400+</span> hampers hand-packed
            </p>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          >
            <p className="text-[11px] uppercase tracking-wider text-gold-600 dark:text-gold-400 font-medium group-hover:text-wine-700 dark:group-hover:text-gold-300 transition-colors">
              Hand-packed →
            </p>
            <p className="text-sm font-display font-semibold text-wine-700 dark:text-white">Small batches</p>
          </Link>
          ...
          >
            ...
            <p className="text-sm font-display font-semibold text-wine-700 dark:text-white">Delivery</p>
          </Link>
        </div>
      </div>
    </section>
