              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredProducts.map((product) => {
                  ...
                  return (
                    <article
                      key={product.id}
                      className="group relative flex flex-col justify-between rounded-3xl bg-white dark:bg-gray-800 p-4 shadow-sm hover:shadow-xl transition-all duration-300 ring-1 ring-cream-200/70 dark:ring-gray-700 hover:-translate-y-1"
                    >
                      <div>
                        ...
                        <div className="relative aspect-square w-full overflow-hidden rounded-2xl bg-cream-100">
                          ...
                          <div className="absolute top-3 left-3 flex flex-col gap-1 z-10">
                            {product.tag && (
                              <span className="inline-flex items-center gap-1 rounded-full bg-wine-700/90 text-cream-50 backdrop-blur-md px-3 py-1 text-[10px] font-semibold uppercase tracking-wider shadow-sm">
                                <Sparkles className="h-3 w-3 text-gold-400" /> {product.tag}
                              </span>
                            )}
                            {discountPercent > 0 && (
                          ...
                          <button
                            ...
                            className="absolute top-3 right-3 grid h-9 w-9 place-items-center rounded-full bg-white/90 dark:bg-gray-800/90 text-wine-700 dark:text-cream-100 shadow-md backdrop-blur-md transition-transform hover:scale-110 active:scale-95"
                            aria-label="Add to wishlist"
                          >
                            <Heart className={`h-4 w-4 ${wishlisted ? 'fill-wine-600 text-wine-600' : ''}`} />
                          </button>
                          ...
                          <div className="absolute inset-x-3 bottom-3 opacity-0 transition-opacity duration-300 group-hover:opacity-100 flex gap-2">
                            <button
                              ...
                              className="w-full inline-flex items-center justify-center gap-1.5 rounded-full bg-white/95 text-wine-800 py-2 text-xs font-semibold shadow-lg backdrop-blur-sm hover:bg-wine-600 hover:text-white transition-colors"
                            >
                        ...
                        <div className="mt-4 px-1">
                          ...
                          <h3
                            onClick={() => setSelectedProduct(product)}
                            className="mt-1 font-display font-semibold text-base text-wine-900 dark:text-cream-100 hover:text-gold-600 cursor-pointer transition-colors line-clamp-1"
                          >
                            {product.name}
                          </h3>

                          <p className="mt-1 text-xs text-ink-700/60 dark:text-gray-400 line-clamp-2 leading-relaxed">
                            {product.description}
                          </p>
                        </div>
                      </div>
                      ...
                      {/* Pricing & Actions */}
                      <div className="mt-4 pt-3 border-t border-cream-100 dark:border-gray-700">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <button
                            ...
                            className="w-full inline-flex items-center justify-center gap-1 rounded-full border border-wine-600/30 dark:border-gray-600 bg-cream-50 dark:bg-gray-700 px-3 py-2 text-xs font-semibold text-wine-700 dark:text-cream-100 hover:bg-wine-600 hover:text-white transition-colors"
                          >
                            <ShoppingBag className="h-3.5 w-3.5" /> Add
                          </button>
                          <button
                            onClick={() => handleBuyNow(product)}
                            className="w-full inline-flex items-center justify-center gap-1 rounded-full bg-wine-600 px-3 py-2 text-xs font-semibold text-cream-50 hover:bg-wine-700 transition-colors shadow-sm"
                          >
