import { Heart, Package, Users, Award, Sparkles } from 'lucide-react';
    ...
    <section id="about" className="py-20 sm:py-28">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="mt-4 font-display font-semibold text-wine-800 dark:text-cream-100 text-3xl sm:text-4xl lg:text-5xl tracking-tight">
            Crafting memories since 2016
          </h2>
          <p className="mt-6 text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            What started as a small artisan workshop has grown into a cherished boutique gifting studio. 
            We believe every hamper should tell a genuine story, hand-packed with pristine craftsmanship and care.
          </p>
        </div>
